      ...
      contenidoEnfermedad.innerHTML = `
       <div class="detalle-item">
        ...
        <strong>Duración:</strong>
         <p>${enfermedad.duracion}</p>
        <strong>Tratamientos:</strong>
        <p>${enfermedad.tratamientos}</p>
        <strong>Riesgo:</strong> <span class="badge-riesgo 
        <p>${getBadgeClass(enfermedad.riesgo)}">${enfermedad.riesgo}</span></p>
        <strong>Transmisión:</strong> 
        <p>${enfermedad.transmision}</p>
